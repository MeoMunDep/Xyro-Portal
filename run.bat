@echo off
title Xyro Portal Bot by @MeoMunDep
color 0A
...
cls
echo =================================================================
echo    Xyro Portal BOT SETUP AND RUN SCRIPT by @MeoMunDep
echo =================================================================
echo.
...
if exist "..\node_modules" (
    ...
    npm install user-agents axios meo-forkcy-utils meo-forkcy-proxy meo-forkcy-colors
    cd %~dp0
) else (
